...
// Portable-Text → plain paragraphs
...
// Portable-Text → plain string for meta description fallback
// eslint-disable-next-line @typescript-eslint/no-explicit-any
...
export default async function BlogPostPage({ params }: Props) {
  ...
  const [paragraphs, itSlug] = await Promise.all([
    Promise.resolve(ptToParagraphs(post.body ?? [])),
    getTranslationSlug(post._id, 'en'),
  ])
